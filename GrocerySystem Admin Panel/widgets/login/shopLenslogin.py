...
class Ui_loginForm(object):
    ...
    def redirectToAdminPanel(self):
        ...
        if(userName == self.userNamelineEdit.text()and passWord == self.passwordlineEdit.text()):
...
"padding-bottom:7px;")
        ...
        self.pushButton.setGeometry(QtCore.QRect(120, 310, 200, 40))
        font = QtGui.QFont()
...
"}")
        ...
        self.newuserLabel.setGeometry(QtCore.QRect(110, 360, 71, 16))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.signupLabel.setGeometry(QtCore.QRect(180, 360, 71, 16))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(True)
    ...
    def retranslateUi(self, loginForm):
        ...
        self.pushButton.setText(_translate("loginForm", "L o g  I n"))
        self.newuserLabel.setText(_translate("loginForm", "New user? "))
        self.signupLabel.setText(_translate("loginForm", "Sign Up"))
        self.versionLabel.setText(_translate("loginForm", "Desktop Client v0.1"))

        self.pushButton.clicked.connect(self.redirectToAdminPanel)
